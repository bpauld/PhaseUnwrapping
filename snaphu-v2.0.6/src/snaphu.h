...
#define DEF_WEIGHTSONLY      FALSE    /* This is a modification to the original code */
...
typedef struct paramST{
  ...
  signed char weightsonly;  /* exit after weights have been computed if TRUE. This is a modification to the original code*/
